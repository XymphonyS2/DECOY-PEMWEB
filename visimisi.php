        ...
        <section id="about" class="about">
            <div class="container">
                <div class="section-title">
                    <h2>Visi dan Misi</h2>
                    <h3>Visi</h3>
                    <p>“Membentuk Pribadi Muslim yang Berakhlak Mulia, Unggul      dalam Ilmu Pengetahuan, Teknologi, Seni dan Budaya”</p>
                    <br>
                    <h3>Misi</h3>
                    <p>Pelaksanaan ibadah kepada Allah SWT.</p>
                    <p>Menumbuhkan suasana kebersamaan dan kekeluargaan.</p>
                    <p>Meningkatkan ukuwah islamiyah dalam kehidupan bermasyarakat.</p>
                    <p>Melaksanakan pembelajaran dan bimbingan secara optimal sesuai dengan potensi diri yang dimiliki.</p>
                    <p>Menumbuhkan semangat keunggulan secara intensif kepada seluruh warga sekolah.</p>
                    <p>Menerapkan manajemen partisipatif dengan melibatkan seluruh warga sekolah.</p>
                    <p>Melengkapi sarana dan prasarana sekolah agar terlaksana kegiatan pembelajaran yang berkualitas.</p>
                    <p>Membentuk peserta didik mampu mewujudkan masyarakat Islam yang sebenar-benarnya.</p>
                    <p>Mengembangkan SDM profesional dan kompetitif yang berbasis teknologi informasi dan berwawasan lingkungan.</p>
                    <p>Membangun jaringan kerja yang harmonis dengan orang tua, masyarakat dan pemerintah.</p>
                </div> 
            </div>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bi bi-chevron-right"></i> <a href="#herotoptop">Visi dan Misi</a></li>
