                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Tentang</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <li><a href="#herotoptop">Tujuan</a></li>
                        </ul>
                    </li>
        ...
        <section id="about" class="about">
            <div class="container">
                <div class="section-title">
                    <h2>Tujuan</h2>
                    <p>Terbentuknya tamatan yang berkepribadian islami.</p>
                    <p>Terwujudnya tamatan yang menjunjung tinggi nilai-nilai kejujuran, objektivitas dan tanggung jawab.</p>
                    <p>Miningkatnya mutu lulusan sesuai dengan standar kompetensi lulusan.</p>
                    <p>Terbentuknya peserta didik yang mampu bersaing di tingkat Nasional dan Internasional.</p>
                    <p>Terwujudnya kader Persyarikatan yang tangguh.</p>
                    <p>Terwujudnya tamatan yang mampu berperan aktif dalam masyarakat global.</p>
                    <p>MTerwujudnya jaringan kerja yang harmonis dengan orang tua, masyarakat dan pemerintah.</p>
                </div> 
            </div>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bi bi-chevron-right"></i> <a href="#herotoptop">Tujuan</a></li>
                    </ul>
                    </li>
                </div>
            </div>
